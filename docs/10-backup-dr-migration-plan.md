...
- [ ] データ分類台帳（Tier1/Tier2/Tier3）が定義される
- [ ] Postgres/Redis/Key Material のRPO/RTOが固定される
- [ ] restore rehearsal 手順が文書化される
- [ ] migration 実行・失敗時対応チェックリストが文書化される
- [ ] DR drill テンプレートと初回実施ログが残る
- [ ] runbook/incident checklist と相互リンクされる
- [ ] `pnpm verify` が通る
...
- [ ] Tier分類/RPO/RTO 定義
- [ ] backup対象・除外対象 定義
- [ ] restore rehearsal runbook 作成
- [ ] migration deploy checklist 作成
- [ ] DR drill template 作成
- [ ] ジョブ停止/再開手順の明記
- [ ] incident/runbook 相互リンク更新
- [ ] `pnpm verify` 通過
